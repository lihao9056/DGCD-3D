...
"""
=================================================
@FileName : inference_model.py.py
@IDE      : PyCharm
@Author   : SS(sammeanshaw@qq.com)
@Date     : 2025/7/22 15:17
=================================================
"""
import torch
...
from pyiqa2.lpips_arch import LPIPS
from pyiqa2.img_util import imread2tensor

from pyiqa2.loss_util import weight_reduce_loss
    ...
    def forward(self, target, ref=None, **kwargs):
        ...
        with torch.set_grad_enabled(self.as_loss):
            ...
            if self.metric_name == 'fid':
                ...
                print(f"metric_name == inception_score")

            else:
                
                if not torch.is_tensor(target):
                    
                    print(f"last metric name")
